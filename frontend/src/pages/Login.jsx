          ...
          <div className="px-10 py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-black hover:bg-gray-800 text-white font-medium py-3.5 px-4 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 shadow-sm hover:shadow-md mt-4"
              >
                Sign In
              </button>
            </form>
